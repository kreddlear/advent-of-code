...
class Monkey:
    ...
    def inspection(self, item_worry_level):
        ...
        # handle worry level divided by 3
        ...
        for monkey in proper_monkey_list:
            if len(monkey.items) > 0:
                for item in monkey.items:
                    # print("now inspecting item",item)
                    new_item_value, monkey_to_throw_to = monkey.inspection(item)
                    # print(new_item_value, monkey_to_throw_to)
